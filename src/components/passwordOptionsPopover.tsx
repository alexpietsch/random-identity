    ...
    return (
        <div className="flex flex-col">
            <div className="flex flex-row items-center">
                <Checkbox className="m-2" id="lowercase" checked={passwordOptions.lowercase} onCheckedChange={(e) => onValueChange(e, PasswordOptionsEnum.lowercase)} />
                <label
                    htmlFor="lowercase"
            ...
            <div className="flex flex-row items-center">
                <Checkbox className="m-2" id="uppercase" checked={passwordOptions.uppercase} onCheckedChange={(e) => onValueChange(e, PasswordOptionsEnum.uppercase)} />
                <label
                    htmlFor="uppercase"
                    className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                >
            ...
            <div className="flex flex-row items-center">
                <Checkbox className="m-2" id="numbers" checked={passwordOptions.numbers} onCheckedChange={(e) => onValueChange(e, PasswordOptionsEnum.numbers)} />
                <label
                    htmlFor="numbers"
                    className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                >
            ...
            <div className="flex flex-row items-center">
                <Checkbox className="m-2" id="symbols" checked={passwordOptions.symbols} onCheckedChange={(e) => onValueChange(e, PasswordOptionsEnum.symbols)} />
                <label
                    htmlFor="symbols"
                    className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                >
